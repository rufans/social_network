package com.srufanov.socialnetwork.postservice.config;
...
public class SwaggerConfiguration {
    ...
    public Docket generalApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.srufanov.socialnetwork.postservice.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Social network - post service")
