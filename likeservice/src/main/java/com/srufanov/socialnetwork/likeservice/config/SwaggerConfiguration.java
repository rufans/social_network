package com.srufanov.socialnetwork.likeservice.config;
...
public class SwaggerConfiguration {
    ...
    public Docket generalApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.srufanov.socialnetwork.likeservice.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Social network - like service")
